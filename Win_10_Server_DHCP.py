import vagrant,os
#Script voor de windows server DHCP
...
def OmgevingAanmaken():
    ...
    with open("Vagrantfile","w") as vagrantFile:
        ...
        vagrantFile.write('config.vm.provision "shell", path: "../Provisionscipts/winServer_DHCP.sh" \n')
...
def VoegToeAanFile():
    with open("..\Hostfile.txt", "a") as file:
                file.write("\n Computernaam:"+str(computerNaam+" IP:"+ipAddress+" OS:Windows Server Boxnaam:"+computerNaam))
