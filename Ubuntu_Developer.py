import vagrant,os
#Script voor de ubuntu developer host
...
def OmgevingAanmaken():
    ...
    vagrantInit = "\t config.vm.box = \"bento/ubuntu-16.04\" \n"
    ...
    with open("Vagrantfile","w") as vagrantFile:
        ...
        vagrantFile.write('config.vm.provision "shell", path: "../Provisionscipts/ubuntu_developer.sh" \n')
